...
#include "../../../libs/DAFX/EQ/ParametricEQ.h"
...
public:
    SIMDEQ()
    {
        eq = std::make_unique<ParametricEQ<juce::dsp::SIMDRegister<float>>>();
    ...
    void process(const juce::dsp::ProcessContextReplacing<float>& context)
    {
        ...
        eq->process(juce::dsp::ProcessContextReplacing<juce::dsp::SIMDRegister<float>>(interleaved)); // [12]
    ...
    std::unique_ptr<ParametricEQ<juce::dsp::SIMDRegister<float>>> eq;
